<template>
    <header class="header-menu">
        <!-- 本页面命名为首页 index.vue 页面, 用户登录之前就确定语言, 国际化信息 -->
        <!-- 登录后的页面命名为 主页 home.vue 页面 -->

        <!-- github 首页 有登录 注册 按钮 -->
        <router-link to="/test" class="link-page test"> 测试页面 </router-link>
        <router-link to="/login" class="link-page login"> {{$t("index.login")}} </router-link>
        <router-link to="/register" class="link-page register"> {{$t("index.register")}} </router-link>
